  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-white">
      ...
      <main className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4">
        ...
        {/* 3D Canvas Container */}
        <div className="relative h-[50vh] md:h-[55vh] w-full max-w-3xl">
        ...
        {/* Stats Section */}
        <div className="mt-6 flex flex-wrap justify-center gap-12 md:gap-20">
          <StatCard value="∞" label="Distance" />
          <StatCard value="100%" label="Determination" />
          <StatCard value="NOW" label="The Time" />
        </div>
      </main>
...
function StatCard({ value, label }: { value: string; label: string }) {
  return (
    <div className="text-center">
      ...
      <div className="mt-1 text-xs text-neutral-400 uppercase tracking-wider">
        {label}
      </div>
    </div>
  );
